window.addEventListener("load", function () {
  ...
  class UI {
    ...
    draw(context) {
      ...
      // timer
      const formattedTime = (this.game.gameTime * 0.001).toFixed();
      context.fillText("Timer: " + formattedTime, 20, 10);
      //  game over messages
        ...
        this.player.projectiles.forEach((projectile) => {
          if (this.checkCollision(projectile, enemy)) {
            ...
            if (enemy.lives <= 0) {
              ...
              if (!this.gameOver) this.score += enemy.score; // Incrementa il punteggio
